//
//  RelationshipModalViewController.swift
//  Posifocus
//
...
protocol RelationshipModalViewControllerDelegate: class {
    func removeBlurredBackgroundView()
    func addNewItem(itemName: String)
    func editItem(itemName: String, indexPath: IndexPath)
}

class RelationshipModalViewController: UIViewController, UITextViewDelegate, UITextFieldDelegate {
    
    let realm = try! Realm()
    var itemList: Results<Relationship>?
    
    var indexPath: IndexPath? = nil
    weak var delegate: RelationshipModalViewControllerDelegate?
    ...
    override func viewDidLoad() {
        ...
        if (indexPath != nil) {
            ...
            itemName.delegate = self
            itemName.text = "Jake Johnson..."
        }
        
        // Set Save Button Color
        saveButton.backgroundColor = UIColor.pfRelationship
    }
